...
const CAT_COLOR: Record<string, React.CSSProperties> = {
  ...
  '其他':{background:'#EEF3F8',color:'#4A6885'},
}
  ...
  return (
    <div className="pb-24 px-4 pt-6">
      ...
      <div className="flex justify-between items-center mb-2.5">
        ...
        <Link href="/history" className="text-xs font-medium" style={{color:'#00A86B'}}>查看全部 →</Link>
      </div>
      ...
      <nav className="nav-bar">
        <Link href="/" className="flex flex-col items-center gap-0.5" style={{color:NAV_ACTIVE}}>
          <span className="text-xl">🏠</span><span className="text-xs font-medium">首頁</span>
        </Link>
        <Link href="/history" className="flex flex-col items-center gap-0.5" style={{color:NAV_INACTIVE}}>
          <span className="text-xl">📋</span><span className="text-xs">記錄</span>
        </Link>
        <Link href="/scan" className="flex flex-col items-center gap-0.5" style={{color:NAV_INACTIVE}}>
          <span className="text-xl">📷</span><span className="text-xs">記帳</span>
        </Link>
        <Link href="/stats" className="flex flex-col items-center gap-0.5" style={{color:NAV_INACTIVE}}>
          <span className="text-xl">📊</span><span className="text-xs">統計</span>
        </Link>
        <Link href="/settings" className="flex flex-col items-center gap-0.5" style={{color:NAV_INACTIVE}}>
